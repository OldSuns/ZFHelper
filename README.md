...
Version **0.1.0+1**, under development. The application UI is currently Simplified Chinese; English documentation does not imply an English UI. School compatibility and release readiness still require real-school and device acceptance.
...
- Production-device background behavior, release signing, and upgrade flows still require acceptance. Local builds and constructed-data checks do not establish those results.
